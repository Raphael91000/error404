...
export function AnomalousMatterHero({
  ...
  return (
    <section
      role="banner"
      className="relative w-full h-screen bg-emerald-950 text-emerald-50 overflow-hidden"
    >
      <Suspense fallback={<div className="w-full h-full bg-emerald-950" />}>
        <GenerativeArtScene />
      </Suspense>

      <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/95 via-emerald-900/70 to-emerald-800/20 z-10" />
      ...
      <div className="relative z-20 flex flex-col items-center justify-end h-full pb-20 md:pb-32 text-center">
        <div className="max-w-3xl px-4 animate-fade-in-long">
          ...
          <p className="mt-6 max-w-xl mx-auto text-base leading-relaxed text-emerald-100/80">
            {description}
          </p>
        </div>
      </div>
