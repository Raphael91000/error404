...
function DefaultDemo() {
  return (
    <AnimatedText
      text={(
        <>
          <span className="text-emerald-400">NeuroBots</span>
          <span className="text-white"> By R</span>
        </>
      )}
      textClassName="text-3xl font-semibold text-white"
      underlineClassName="text-white hidden"
    />
  );
}
...
function CustomStyleDemo() {
  return (
    <AnimatedText
      ...
      textClassName="text-5xl font-bold text-white mb-2"
      underlineClassName="text-white hidden"
      underlinePath="M 0,10 Q 75,0 150,10 Q 225,20 300,10"
      underlineHoverPath="M 0,10 Q 75,20 150,10 Q 225,0 300,10"
      underlineDuration={1.5}
