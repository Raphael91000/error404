...
const GLSLHills = ({
  ...
  const colors = useMemo(
    () => ({
      ...
      glow: palette.glow instanceof THREE.Color ? palette.glow : new THREE.Color(palette.glow),
      bg: palette.bg instanceof THREE.Color ? palette.bg : new THREE.Color(palette.bg),
    }),
    [palette.base, palette.glow, palette.bg],
  );
        ...
        return new THREE.Mesh(
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                float heightFactor = clamp((vPosition.y + 80.0) / 160.0, 0.0, 1.0);
                float glow = smoothstep(0.4, 1.0, heightFactor);
